...
if ( !class_exists( 'MeowKit_MGL_Helpers' ) ) {

  class MeowKit_MGL_Helpers {
    //public static $version = MeowKit_MGL_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MGL_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MGL_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MGL_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MGL_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MGL_Helpers::$startQueries[ $timerName ];
  ...
  // if ( MeowKit_MGL_Helpers::is_rest() ) {
